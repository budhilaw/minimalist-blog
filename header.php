...
<div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'budhilaw-blog' ); ?></a>
            ...
            <div class="site-header-inner">
                ...
                <nav id="site-navigation" class="main-navigation">
                    <button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false">
                        ...
                        <span class="screen-reader-text"><?php esc_html_e( 'Menu', 'budhilaw-blog' ); ?></span>
                    </button>
                    <?php
                    wp_nav_menu(
                        array(
                            ...
                            'container'      => false,
                            'menu_class'     => 'menu',
                            'walker'         => new Budhilaw_Blog_Nav_Walker(),
                        )
                    );
                    ?>
                </nav><!-- #site-navigation -->
